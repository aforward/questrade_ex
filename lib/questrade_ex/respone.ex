defmodule QuestradeEx.Response do
  @moduledoc """
  ...
  ## Example
      ...
      iex> QuestradeEx.Response.normalize({:ok, %{body: "{\\"answer\\": 42}", status_code: 200, headers: [{"Content-Type", "application/json"}]}})
      {200, "{\\"answer\\": 42}", [{"Content-Type", "application/json"}]}

      iex> QuestradeEx.Response.normalize({:error, %{reason: :nxdomain}})
      {:error, :nxdomain, []}
