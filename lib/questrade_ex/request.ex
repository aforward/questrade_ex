defmodule QuestradeEx.Request do
  @moduledoc """
  ...
  alias QuestradeEx.{Request, Opts, Url, Content}
  ...
  ## Example
      ...
      iex> QuestradeEx.Request.create(body: "What you make it!", headers: [{"Content-Type", "application/mystuff"}]).body
      "What you make it!"

      iex> QuestradeEx.Request.create(basic_auth: "api:key-abc123").headers
      [{"Authorization", "Basic #{Base.encode64("api:key-abc123")}"}]

      iex> QuestradeEx.Request.create(basic_user: "api", basic_password: "key-abc123").headers
      [{"Authorization", "Basic #{Base.encode64("api:key-abc123")}"}]

      iex> QuestradeEx.Request.create(bearer_auth: "key-abc456").headers
      [{"Authorization", "Bearer key-abc456"}]

      iex> QuestradeEx.Request.create(bearer_auth: "key-abc456", headers: [{"Content-Type", "application/json"}]).headers
      [{"Authorization", "Bearer key-abc456"}, {"Content-Type", "application/json"}]

      iex> QuestradeEx.Request.create(headers: [{"Authorization", "Bearer key-abc789"}, {"Content-Type", "application/json"}]).headers
      [{"Authorization", "Bearer key-abc789"}, {"Content-Type", "application/json"}]

      iex> QuestradeEx.Request.create(params: [limit: 10], timeout: 1000).http_opts
